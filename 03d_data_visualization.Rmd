...
## Stacked barcharts
> Note: We will plot the barcharts based on the mean relative abundance.

```{r ggplot_barchart, fig.height=10, fig.width=10, animation.hook='gifski', interval=4, fig.width=4}
set.seed(110912)
