...
save(otutable, otutable_long, taxonomy, file = "RDataRDS/saved_objects.RData")
```
...
resave(otutable, otutable_long, taxonomy, file = "RDataRDS/saved_objects.RData")
```
